...
def process_sensors() -> None:
    ...
    """
    sensor_1_thread = threading.Thread(target=process_sensor, args=('Sensor 1',))
    sensor_2_thread = threading.Thread(target=process_sensor, args=('Sensor 2',))
    sensor_3_thread = threading.Thread(target=process_sensor, args=('Sensor 3',))
